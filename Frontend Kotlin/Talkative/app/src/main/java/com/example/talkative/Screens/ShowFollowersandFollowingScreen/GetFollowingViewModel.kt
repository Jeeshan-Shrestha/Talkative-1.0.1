...
import com.example.talkative.repository.GetFollowingRepository
...
@HiltViewModel
class GetFollowingViewModel @Inject constructor(private val repository: GetFollowingRepository): ViewModel(){
